...
-- Export de la structure de table dindhouet. challenge
...
-- Export de données de la table dindhouet.challenge: ~3 rows (environ)
...
-- Export de la structure de table dindhouet. classe
...
-- Export de données de la table dindhouet.classe: ~12 rows (environ)
...
-- Export de la structure de table dindhouet. club
...
-- Export de données de la table dindhouet.club: ~4 rows (environ)
...
-- Export de la structure de table dindhouet. commissaire
...
-- Export de données de la table dindhouet.commissaire: ~3 rows (environ)
...
-- Export de la structure de table dindhouet. equipage
...
-- Export de données de la table dindhouet.equipage: ~36 rows (environ)
...
-- Export de la structure de table dindhouet. membre_equipage
...
-- Export de données de la table dindhouet.membre_equipage: ~9 rows (environ)
...
-- Export de la structure de table dindhouet. participation
...
-- Export de données de la table dindhouet.participation: ~19 rows (environ)
...
-- Export de la structure de table dindhouet. proprietaire
...
-- Export de données de la table dindhouet.proprietaire: ~22 rows (environ)
...
INSERT INTO `proprietaire` (`Num_proprietaire`, `Num_club`, `Nom_proprietaire`, `Coordonnees_proprietaire`, `Compte_participant`) VALUES
	...
	(12, 2, 'Bond', 'NY', 'O'),
	(13, 4, 'dindon', 'nostang', 'o'),
	(14, 3, 'Batman', 'Batcave', 'N'),
	(15, 2, 'Nasty Nathy', 'Twerkland', 'O'),
	(16, 3, 'Chonchon', 'Maxroom', 'o'),
	(18, 3, 'zouzou', 'dindland', 'N'),
	(19, 4, 'La Crampe', 'La cave', 'N'),
	(20, 2, 'Dinchonchon', 'Max\'s room', 'O'),
	(30, 4, 'l\'dindon', 'bassecour', 'o'),
	(31, 4, 'Kirikou', 'Savana', 'O'),
	(32, 3, 'Dinglouwich', 'Subwindon', 'O');
/*!40000 ALTER TABLE `proprietaire` ENABLE KEYS */;


-- Export de la structure de table dindhouet. regate
...
-- Export de données de la table dindhouet.regate: ~24 rows (environ)
...
-- Export de la structure de table dindhouet. serie
...
-- Export de données de la table dindhouet.serie: ~2 rows (environ)
...
-- Export de la structure de table dindhouet. voilier
...
INSERT INTO `voilier` (`Num_voile`, `Num_proprietaire`, `Nom_classe`, `Nom_voilier`) VALUES
	...
	(13, 16, 'LongTZE', 'ronchon'),
	(14, 15, 'Corsaire', 'TwerkBoat'),
	(17, 3, 'Corsaire', 'dindn'),
	(18, 2, 'Corsaire', 'dindon'),
	(19, 5, 'Corsaire', 'dindonnette'),
	(20, 2, 'Corsaire', 'L\'dindon'),
	(21, 14, 'Aile', 'Cacaouet'),
	(22, 2, 'Corsaire', 'glougloat'),
	(23, 4, 'Corsaire', 'Avenger'),
	(24, 20, 'Corsaire', 'Batoglou'),
	(25, 3, 'Aile', 'toto'),
	(26, 2, 'Dragon', 'Bazookboat');
/*!40000 ALTER TABLE `voilier` ENABLE KEYS */;


-- Export de la structure de procedure dindhouet. P1
DELIMITER //
...
-- Export de la structure de procedure dindhouet. P2
DELIMITER //
...
-- Export de la structure de procedure dindhouet. P3
DELIMITER //
...
-- Export de la structure de déclancheur dindhouet. participation_before_update
...
-- Export de la structure de déclancheur dindhouet. regate_before_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Export de la structure de déclancheur dindhouet. regate_before_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Export de la structure de déclancheur dindhouet. regate_before_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
