...
public class ProprioNyf 
{
	protected int num_proprietaire, num_club;
	protected String nom_proprietaire, coordonnees_proprietaire,compte_participant;
	
	
	public ProprioNyf(int num_proprietaire, int num_club,
			String nom_proprietaire, String coordonnees_proprietaire, String compte_participant) 
	{
		super();
